...
This example demonstrates using a "wrapper" component around the component generated by this script. This exmaple
assumes the existing project structure is as follows:
...
```shell
react-svgs -i src/assets -o src/components/icon/svg
```
